...
from .views import HomePageView, EventListView, EventDetailView, UserEventListView, EditorEventListView
...
urlpatterns = [
    ...
    path("eventi_inseriti/", EditorEventListView.as_view(), name="eventi_prenotati"),
]
